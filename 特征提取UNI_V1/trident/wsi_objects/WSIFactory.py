...
WSIReaderType =  Union['openslide', 'image', 'cucim']
...
def load_wsi(
    ...
    **kwargs : dict
    ...
    if reader_type == 'aslide' or (ext == '.kfb' and reader_type is None):
        from .aslide_backend import AslideWSI
        return AslideWSI(slide_path)
